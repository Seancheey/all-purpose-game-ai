...
from components.utils.image_format import np_keys_filename, avi_video_filename, np_screens_filename
...
class Recorder:
    ...
    key_recording_delay_sec: float = -0.004  # record key events N sec earlier to compensate for model predication delay
